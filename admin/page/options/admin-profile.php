          ...
          <li class="treeview active">
                ...
                <ul class="treeview-menu">
                  <li class="treeview active"><a href="#"><i class="fa fa-circle-o"></i> Admins <span class="pull-right-container"><i class="fa fa-angle-left pull-right"></i></span></a>
                    <ul class="treeview-menu">
                        <li class="active"><a href="./admin-profile.php"><i class="fa fa-circle-o"></i> Admin Detail </a></li>
            ...
            <div class="col-md-3">
              ...
              <div class="box box-primary">
                <div class="box-body box-profile">
                  ...
                  <h3 class="profile-username text-center">Ms. Nina Mcintire</h3>
                  ...
                  <ul class="list-group list-group-unbordered">
                    ...
                    <li class="list-group-item">
                      <b>Admin Status</b> <a class="pull-right">Active</a>
                    </li>
                    <li class="list-group-item">
                      <b>Email</b> <a class="pull-right">Ninatire@gmail.com</a>
                    </li>
                  </ul>
                  <a href="./admin-login-detail.php" class="btn btn-primary btn-block"><b>Login Detail</b></a>
                  <a href="./permission.php" class="btn btn-primary btn-block"><b>Permissions</b></a>
                </div>
                <!-- /.box-body -->
              </div>
              <!-- /.box -->
              ...
              <div class="box box-primary">
                ...
                <div class="box-body">
                  ...
                  <p class="text-muted">
                    B.S. in Computer Science from the Polytechnic University of The Philippines at Sta Mesa, Manila
                  </p>
                  ...
                  <div class="tab-pane" id="settings">
                    <form class="form-horizontal">
                      <div class="form-group">
                        <label for="inputName" class="col-sm-2 control-label">Salutations</label>
    
                        <div class="col-sm-10">
                          <input type="text" class="form-control" id="inputSalutation" placeholder="Salutations">
                        </div>
                      </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                              <label for="inputText" class="col-sm-2 control-label">Extension</label>
          
                              <div class="col-sm-10">
                                <input type="text" class="form-control" id="inputExtension" placeholder="Extension">
                              </div>
                            </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        <label for="inputSkills" class="col-sm-2 control-label">Highest Education</label>
...
<!-- Page Script -->
<script src="../../dist/js/pages/admin-profile.js"></script>
<script>

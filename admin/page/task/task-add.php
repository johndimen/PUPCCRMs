                      ...
                      <div class="form-group">
                        <label for="inputDateDue" class="col-sm-3 control-label">Date Due</label>
                          <div class="col-sm-8 input-group date" style="width: 63%;padding-left: 15px;">
                            ...
                            <input type="date" class="form-control pull-right" id="inputDateDue" name="datedue" placeholder="mm/dd/yyyy">
                          </div>
                      </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <textarea class="form-control" id="inputDescription" name="description" rows="5" placeholder="Task Description"></textarea>
                  </div>
                </div>
                  <div class="form-group">

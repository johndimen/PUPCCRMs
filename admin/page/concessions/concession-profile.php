...
<head>
  ...
  <title>PUPCCRMs | Admin Profile</title>
...
<div class="wrapper">
          ...
          <li class="treeview">
                ...
                <ul class="treeview-menu">
                  <li class="treeview"><a href="#"><i class="fa fa-circle-o"></i> Admins <span class="pull-right-container"><i class="fa fa-angle-left pull-right"></i></span></a>
                    <ul class="treeview-menu">
                        <li class="active"><a href="../options/admin-profile.php"><i class="fa fa-circle-o"></i> Admin Detail </a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
            <h1>
              Concession Details
              <small>Concession Profile</small>
            </h1>
            <ol class="breadcrumb">
              <li><a href="../../index.php"><i class="fa fa-dashboard"></i> Home</a></li>
              <li><a href="./concession.php">Concession</a></li>
              <li><a href="#">Details</a></li>
              <li class="active">Concession Profile</li>
            </ol>
          </section>
    ...
    <section class="content">
        ...
        <div class="row">
            <div class="col-md-3">
              ...
              <div class="box box-primary">
                <div class="box-body box-profile">
                  ...
                  <h3 class="profile-username text-center"> Mcintire shop</h3>
    
                  <p class="text-muted text-center">Concessionaire</p>
    
                  <ul class="list-group list-group-unbordered">
                    <li class="list-group-item">
                      <b>Stall No.</b> <a class="pull-right">1</a>
                    </li>
                    <li class="list-group-item">
                      <b>Area</b> <a class="pull-right">Lagoon</a>
                    </li>
                    <li class="list-group-item">
                      <b>Items/Products</b> <a class="pull-right">13</a>
                    </li>
                    <li class="list-group-item">
                      <b>Other Items</b> <a class="pull-right">4</a>
                    </li>
                    <li class="list-group-item">
                      <b>Services</b> <a class="pull-right">5</a>
                    </li>
                    <li class="list-group-item">
                      <b>Equipments</b> <a class="pull-right">10</a>
                    </li>
                  </ul>
              ...
              <div class="box box-primary">
                ...
                <!-- /.box-header -->
                <div class="box-body">
                  <strong><i class="fa fa-certificate margin-r-5"></i> Owner</strong>

                  <p class="text-muted">
                    <b>Name:</b>Nina Mcintire
                  </p>

                  <hr>

                  <strong><i class="fa fa-certificate margin-r-5"></i> Contract</strong>
    
                  <p class="text-muted">
                    <b>Contract Signed:</b>January 3, 2019
                  </p>
                  <p class="text-muted">
                    <b>Contract Expires:</b>January 3, 2020
                  </p>
                  ...
                  <strong><i class="fa fa-vcard margin-r-5"></i> Status</strong>
                  ...
                  <strong><i class="fa fa-file-text-o margin-r-5"></i> Date Applied</strong>
    
                  <p class="text-muted">December 1, 2018</p>
                </div>
                <!-- /.box-body -->
              </div>
              <!-- /.box -->
            ...
            <div class="col-md-9">
              <div class="nav-tabs-custom" id="profile_tabs">
                <ul class="nav nav-tabs">
                  <li class="active"><a href="#activity" data-toggle="tab">Activity</a></li>
                  <li><a href="#timeline" data-toggle="tab">Timeline</a></li>
                  <li><a href="#map" data-toggle="tab">Map/Images</a></li>
                ...
                <div class="tab-content">
                      ...
                      <div class="box box-default collapsed-box">
                          ...
                          <div class="box-body form-group" >
                            <div  style="padding-left: 10px">
                              <label for="mapInputFile">Map Image Input</label>
                  ...
                  <div class="tab-pane" id="experience">
                      <div class="box box-solid">
                          <div class="box-header with-border">
                            <h3 class="box-title"><strong>Concession Experience</strong> </h3>
                          </div>
                          ...
                          <div class="box-body">
                            <table class="table table-striped">
                              <tbody>
                                <tr>
                                  <th style="width: 10px;">Experience Number</th>
                                  <th>Place</th>
                                  <th>Year(s) in Concession</th>
                                </tr>
                              </tbody>
                            </table>
                          </div>
                  ...
                  <div class="tab-pane" id="services">
                      <div class="box box-solid">
                          <div class="box-header with-border">
                            <h3 class="box-title"><strong>Concession Services</strong> </h3>
                          </div>
                          ...
                          <div class="box-body">
                            <table class="table table-striped">
                              <tbody>
                                <tr>
                                  <th style="width: 10px;">Service Number</th>
                                  <th>Service Name</th>
                                  <th>Description</th>
                                  <th>Price Range</th>
                                </tr>
                  ...
                  <div class="tab-pane" id="items">
                    ...
                    <div class="box collapsed-box">
                      <div class="box-header with-border">
                        <h3 class="box-title"><strong>Food Items</strong> </h3>
                          <div class="box-tools pull-right">
                            <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-plus"></i>
                            </button>
                          </div>
                    ...
                    <div class="box collapsed-box">
                        <div class="box-header with-border">
                          <h3 class="box-title"> <strong>Non-Food Items</strong> </h3>
                            <div class="box-tools pull-right">
                              <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-plus"></i>
                              </button>
                            </div>
                      ...
                      <!-- Other Items-->
                        <div class="box collapsed-box">
                          <div class="box-header with-border">
                            <h3 class="box-title"><strong>Other Items</strong></h3>
                              <div class="box-tools pull-right">
                                <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-plus"></i>
                                </button>
                              </div>
                  ...
                  <div class="tab-pane" id="equipment">
                      <div class="box box-solid">
                          <div class="box-header with-border">
                            <h3 class="box-title"><b>Equipment</b></h3>
                          </div>

                        <table class="table table-striped">
                          <tbody>
                            <tr>
                              <th style="width: 10px;">Equipment Number</th>
                              <th>Name</th>
                              <th>Brand</th>
                              <th>Description</th>
                              <th>Wattage</th>
                  ...
                  <div class="tab-pane" id="contract">
                      <div class="box box-solid">
                          <div class="box-header with-border"> 
                            <h3 class="box-title"> <b>Contract</b></h3>
                          </div>

                            <table class="table table-striped">
                              <tbody>
                                <tr>
                                  <th style="width: 10px;">Contract Number</th>
                                  <th>Name</th>
                                  <th>Description</th>
                                  <th>Duration</th>
                                  <th>Consignee</th>
...
<!-- Page Script -->
<script src="../../dist/js/pages/concession-profile.js"></script>
<script>
  $(function () {

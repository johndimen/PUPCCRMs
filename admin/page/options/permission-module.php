...
<head>
  ...
  <title>PUPCCRMs | Module Permissions</title>
...
<div class="wrapper">
          ...
          <li class="treeview active">
                ...
                <ul class="treeview-menu">
                  ...
                  <li class="treeview active"><a href="./permission.php"><i class="fa fa-circle-o"></i> Permissions <span class="pull-right-container"><i class="fa fa-angle-left pull-right"></i></span></a>
                    <ul class="treeview-menu">
                        <li class="active"><a href="./permission-module.php"><i class="fa fa-circle-o"></i> Module Permission</a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
          Module Permissions
          <small>All Module Permissions</small>
        </h1>
        <ol class="breadcrumb">
          <li><a href="../../index.php"><i class="fa fa-dashboard"></i> Home</a></li>
          <li><a href="#">Options</a></li>
          <li><a href="./permission.php">Permissions</a></li>
          <li class="active">Module Permissions</li>
        </ol>
      </section>
    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-header with-border">
            <h3 class="box-title"><strong>Module Permission</strong> </h3>
            ...
            <table class="table table-striped">
                <tbody>
                    <tr>
                        ...
                        <th style="width: 50PX">Trash</th>
                        <th style="width: 50px">Create Archive</th>
                        <th style="width: 50px">Read Archive</th>
                        <th style="width: 50px">Bulletin</th>
    ...
    <div class="modal-dialog">
      <div class="modal-content" style="border-radius: 10px">
        <div class="modal-header">
          ...
          <h4 class="modal-title">Add New Module Permission</h4>
        </div>
        ...
        <div class="modal-footer">
          ...
          <button type="submit" id="submitModule" name="submitModule" class="btn btn-primary">Submit</button>  
        </div>  
        </form>
      </div>
    </div>
...
<!-- Page Script -->
<script src="../../dist/js/pages/permission-module.js"></script>
<script>

    ...
    <section class="content">
      ...
      <div class="row">
          <div class="col-md-3">
              ...
              <a href="./task-add.php" class="btn btn-primary btn-block margin-bottom">Add Task</a>
                      ...
                      <table class="table table-hover table-striped">
                        <tbody>
                              ...
                              <?php while($row30 = mysqli_fetch_array($query30)){?>
                                ...
                                <td>
                                <a type="button" class="btn btn-primary" href="./concession-view.php?id=<?php echo $row30[7]?>">View</button></a>

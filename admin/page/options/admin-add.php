      ...
      <div class="box">
        ...
        <div class="row">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <textarea id="location" name="location" class="form-control" rows="4" placeholder="Address"></textarea>
            ...
            <div class="form-group">
              <label for="conpassword" class="col-sm-4 control-label">Password</label>
              <div class="col-sm-7">
                <input id="conpassword" name ="conpassword" type="password" class="form-control" placeholder="Confirm Password">
              </div>
            </div> 
            <br>

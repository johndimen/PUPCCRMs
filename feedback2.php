                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
			    								    <div class="form-check">
                                                        <P>How would you rate the products priced?</P>
                                                    ...
                                                    <div class="form-check">
                                                        <P>How would you rate your interaction with our concessionaire?</P>
                                                        <label for="question3" class="form-text-label" >
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="form-check">
                                                        <P>How are your experienced buying our  product?</P>
                                                    ...
                                                    <div class="form-check">
                                                        <P>How would you rate your expectation with the product?</P>
                                                        <label for="question7" class="form-text-label" >
                                                            <select name = "price" class = "default-select" id = "default-select" required>
			    									    	    <option value = "1">Outstanding</option>
				    				    			    		<option value = "2">Very Good</option>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <select name="feedbacktype" id="feebacktype" class="defalt-select">
                                                    <option value=""Seledted  name = "feedback_type"> Select Feedback Type</option>

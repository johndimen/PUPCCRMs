...
<head>
  ...
  <title>PUPCCRMs | Admin Role</title>
...
<div class="wrapper">
        ...
        <ul class="sidebar-menu" data-widget="tree">
          ...
          <li class="treeview active">
                ...
                <ul class="treeview-menu">
                  ...
                  <li class="active"><a href="./role.php"><i class="fa fa-circle-o"></i>Admin Roles</a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
            <h1>
              Admin Roles
              <small>System Admin Roles</small>
            </h1>
            <ol class="breadcrumb">
    ...
    <div class="col-md-8">
      ...
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title"><strong>Admin Roles</strong> </h3>
            ...
            <table class="table table-striped">
                <tbody>
                    <tr>
                        ...
                        <th style="width: 200px">Admin Role</th>
                    ...
                    <?php 
                    $action = '
                        <a type="button" class="btn btn-primary" href="./role-edit.php">Edit</a>
        ...
        <div class="box">
          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-9">
                <textarea type="text" id="adminRole" name="adminRole" class="form-control" rows="5" placeholder="Role Description"></textarea>
              </div>
            </div>
          </div>
          <div class="box-footer">
            <button type="reset" id="reset" name="reset" class="btn btn-default pull-left">Reset Fields</button>
      ...
      <div class="modal-dialog">
          <div class="modal-content" style="border-radius:10px">
              ...
              <div class="modal-footer">
                <button type="button" class="btn btn-default pull-left" name="close" id="close" data-dismiss="modal">No</button>
                <button type="submit" class="btn btn-danger" name="submit" id="submit">Yes</button>
              </div>
          </div>
      </div>
  </div>
...
<!-- Page Script -->
<script src="../../dist/js/pages/audit-trail.js"></script>
<script>

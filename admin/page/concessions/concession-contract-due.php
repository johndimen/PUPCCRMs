...
<head>
  ...
  <title>PUPCCRMs | Concession Contract Due</title>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
          Contracts
          <small>All Concession Contracts Due</small>
        </h1>
        <ol class="breadcrumb">
              ...
              <div class="box box-solid">
                ...
                <div class="box-body no-padding">
                  <ul class="nav nav-pills nav-stacked">
                    ...
                    <li class="active"><a href="./concession-contract-due.php"><i class="fa fa-exclamation-circle"></i> Contract Due</a></li>
            ...
            <!-- /.col -->
              <div class="col-md-9">
                <div class="box box-primary">
                  <div class="box-header with-border">
                    <h3 class="box-title"><strong>Due ContractBox</strong></h3>
                    ...
                    <div class="table-responsive mailbox-massages">
                      <table class="table table-hover table-striped">
                        <tbody>
                          ...
                          <?php $action = '<a type="button" class="btn btn-info " href="./concession-contract-due-view.php">View</a>';?>
    ...
    <div class="modal-dialog">
      <div class="modal-content" style="border-radius:10px">
        <div class="modal-header">
          <h3 class="modal-title">Due Contract</h3>
        </div>
        ...
        <div class="modal-footer">
          ...
          <button type="button" name="archive" class="btn btn-success" data-toggle="modal" data-target="#archiveModal">Archive</button>

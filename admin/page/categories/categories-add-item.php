      ...
      <div class="col-md-12">
        <div class="box box-bordered box-primary">
          <div class="box-header">
            <h3 class="box-title">Add Item/Product Category</h3>
          </div>
        <form class="form-horizontal" action="" method="post">
          <div class="box-content">
          <center><h4>Item Category</h4></center>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                              <div class="input-group">
                                ...
                                <input type="number" min="0" name="price" id="price" class="form-control" placeholder="0">

      ...
      <div class="col-md-12">
        <div class="box box-bordered box-primary">
          <div class="box-header">
            <h3 class="box-title">View Equipment Brand Category</h3>
          </div>
        <form class="form-horizontal" action="" method="post">
          <div class="box-content">
          <center><h4>Brand Category</h4></center>
                        <div class="form-group">
                            <label for="id" class="control-label col-sm-3">ID Number</label>
                            <div class="col-sm-8">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-8">
                            <textarea type="text" class="form-control" rows="5" name="desc" id="desc" disabled></textarea>
                          </div>
                        </div>
          </div>
          <div class="box-footer">
                <a type="button" name="delete" data-target="#deleteServiceModal" data-toggle="modal" class="btn btn-danger">Delete</a>
                <a type="button" name="edit" class="btn btn-info pull-right" href="./categories-edit-equipmentbrand.php">Edit</a>
          </div>
        </form> 
        </div>
      </div>

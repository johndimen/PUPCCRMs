    ...
    <section class="content">
      ...
      <div class="row">
          <div class="col-md-3">
              ...
              <a href="./concession-map-images-add.php" class="btn btn-primary btn-block margin-bottom">Add Image</a>
              ...
              <div class="box box-solid">
                ...
                <div class="box-body no-padding">
                  <ul class="nav nav-pills nav-stacked">
                    <li class="active"><a href="./concession-map-images.php"><i class="fa fa-th-large"></i> Imagebox</a></li>
            ...
            <div class="col-md-9">
                <div class="box box-primary">
                  <div class="box-header with-border">
                    <h3 class="box-title"><strong>MapBox</strong></h3>
                    ...
                    <div class="table-responsive mailbox-massages">
                      <table class="table table-hover table-striped">
                        <tbody>
                          ...
                          <?php 
                          $action = '
                                <a type="button" class="btn btn-info  " href="./concession-map-images-view.php">View</a>
                            ';
                            ?>
                          <tr>
                            <td></td>

      ...
      <div class="box">
        ...
        <div class="box-body">
          <div class="form-group">
            <label for="adminName" class="col-sm-4 control-label">Admin</label>
            <div class="col-sm-4">
                <input type="text" class="form-control" name="adminName" id="adminName" disabled>
            </div>
          </div>
          <div class="form-group">
            <label for="adminRole" class="col-sm-4 control-label">Admin Role</label>
            <div class="col-sm-4">
              <input type="text" id="adminRole" name="adminRole" class="form-control" placeholder="Admin Role" disabled>
            </div>
          </div>
          <hr>
          <center><h4>Permissions</h4></center>
          <div class="form-group">
            <div class="row" style="padding-right: 100px">
              <label class="col-sm-4 control-label"> Tasks
                <input type="checkbox" class="flat-red form-control" disabled>
              </label>
              ...
              <label class="col-sm-4 control-label">Add Admin
                <input type="checkbox" class="flat-red form-control" disabled>
              </label>
        ...
        <div class="box-footer">
          ...
          <div class="row pull-right" style="margin-right:0px">
            <a href="./permission-change.php" id="change" name="change" class="btn btn-info ">Change Permission</a>
            </div>
        </div>
        </form>
        <!-- /.box-footer-->

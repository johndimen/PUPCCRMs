      ...
      <div class="row">
          <div class="col-md-3">
            ...
            <div class="modal-body form-horizontal">
              ...
              <div class="form-group">
                <label for="viewDateStart" class="col-sm-3 control-label">Date Start</label>
                  <div class="col-sm-8 input-group date" style="width: 64.9%;padding-left: 15px;">
            ...
            <div class="box-footer">
              <button type="button" name="restore" class="btn btn-success" data-toggle="modal" data-target="#restoreModal">Send to Archive</button>

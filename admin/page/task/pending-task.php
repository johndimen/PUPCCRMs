...
<head>
  ...
  <title>PUPCCRMs | Pending Task</title>
        ...
        <ul class="sidebar-menu" data-widget="tree">
          ...
          <li class="treeview active">
            ...
            <ul class="treeview-menu">
              ...
              <li class="active"><a href="./pending-task.php"><i class="fa fa-circle-o"></i>Pending Task <span class="label label-warning pull-right">4</span></a></li>
            </ul>
          </li>
          <li class="treeview">
            <a href="#">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
          ...
          <li class="active"><a href="#">Pending Task</a></li>
        </ol>
      </section>
          ...
          <div class="col-md-3">
              ...
              <div class="box box-solid">
                ...
                <div class="box-body no-padding">
                  <ul class="nav nav-pills nav-stacked">
                    ...
                    <li class="active"><a href="./pending-task.php"><i class="fa fa-exclamation-circle"></i> Pending Task</a></li>
            ...
            <div class="col-md-9">
                <div class="box box-primary">
                  <div class="box-header with-border">
                    <h3 class="box-title"><strong>Pending TaskBox</strong></h3>

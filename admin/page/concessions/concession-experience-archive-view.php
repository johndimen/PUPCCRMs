      ...
      <div class="row">
              ...
              <div class="box box-solid">
                ...
                <div class="box-body no-padding">
                  <ul class="nav nav-pills nav-stacked">
                    ...
                    <li class="active"><a href="./concession-experience-archive.php"><i class="fa fa-archive"></i> Archive <span class="label label-warning pull-right">65</span></a></li>
            ...
            <!-- /.col -->
              <div class="col-md-9">
                <div class="box box-primary">
                  <div class="box-header with-border">
                    <h3 class="box-title"><strong>View Archived Experience</strong></h3>
          ...
          <div class="form-group">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-7">
                <input type="text" class="form-control" names="xpcons" id="xpcons" placeholder="Concession Profile" disabled>
              </div>
            </div>
          <div class="form-group">

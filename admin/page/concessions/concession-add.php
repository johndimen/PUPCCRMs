...
include("../../../php_action/insert/concession.php");
    ...
    <section class="content">
      ...
      <div class="row">
            ...
            <div class="row">
              ...
              <h4 style="margin-left:250px">Profile</h4>
                                    <div class="form-group">
                                      ...
                                      <div class="col-sm-8">
                                      <input type="text" class="form-control" value = "CS-MN-<?php echo $rand?>-<?php echo $day?><?php echo $month?>-<?php echo $year?>" placeholder="Concession Number" name="serial" id="inputConcessionNumber">
                                      </div>
                                    </div>
                                    <div class="form-group">
                                      <label for="inputNumber" class="col-sm-4 control-label">Stall Number</label>
                                      <div class="col-sm-8">
                                        <input type="text" class="form-control" placeholder="Stall Number" name="stall" id="inputNumber">
                                    ...
                                    <div class="form-group">
                                      ...
                                      <div class="col-sm-8">
                                        <input type="text" class="form-control" name="name" id="inputConcessionName" placeholder="Business Name" >
                                      </div>
                                    </div>
                                    <h4>Owner's Info</h4>
                                    <div class="form-group">
                                      ...
                                      <div class="col-sm-8">
                                        <input type="text" class="form-control" name="fname" id="inputOwnerFName" placeholder="First Name">
                                        <input type="text" style="margin-top:5px;margin-bottom:5px" class="form-control" name="mname" id="inputOwnerMName" placeholder="Middle Name">
                                        <input type="text" style="" class="form-control" name="lname" id="inputOwnerLName" placeholder=" Last Name">
                                      </div>
                                    </div>
                                      <div class="form-group">
                                  ...
                                  <div class="col-md-4" style="margin-top:40px">
                                      <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                          <textarea class="form-control" name="remarks" id="inputRemarks" rows="5" placeholder="Remarks" ></textarea>
                                        </div>
                                      </div> 
                                      <div class="form-group">
                                    ...
                                    <div class="form-group" style="margin-top:24px">
                                      ...
                                      <div class="col-sm-8">
                                        <textarea class="form-control" name="address" id="inputAddress" rows="5" placeholder="Address" ></textarea>
                                      </div>
                                    </div>
                                      <div class="form-group" style="margin-top:26px">
                                        ...
                                        <div class="col-sm-8">
                                          <input type="text" class="form-control" name="contact" id="inputnumber" placeholder="Number" >
                                        </div>
                                      </div>
                                    </div>
                                    <div class="col-md-4">
                                      ...
                                      <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                          <select class="form-control select2" style="width: 100%;" name="area" id="dropdown1">
                                      ...
                                      <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                          <input type="text" class="form-control" name="" id="specify" placeholder="0" disabled>
                                        </div>
                                      </div>
                                      <div class="form-group">
          ...
          <div class="box-footer">
            ...
            <button type="submit" name="submit" class="btn btn-success pull-right" name = "submit">Submit</button>
          </div>
        </form>
                    </div>
                  </div>

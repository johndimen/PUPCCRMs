      ...
      <div class="col-md-12">
        <div class="box box-bordered box-primary">
          <div class="box-header">
            <h3 class="box-title">Edit Equipment Name Category</h3>
          </div>
        <form class="form-horizontal" action="" method="post">
          <div class="box-content">
          <center><h4>Equipment Name Category</h4></center>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-9">
                            <textarea type="text" class="form-control" rows="5" name="desc" id="desc" placeholder="Equipment Description"></textarea>
                          </div>
                        </div>
          </div>

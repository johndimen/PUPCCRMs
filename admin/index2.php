...
<div class="wrapper">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="./page/cases/trash-cases.php"><i class="fa fa-circle-o"></i> Trash<span class= "label bg-green pull-right">4</span></a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="./page/task/trash-task.php"><i class="fa fa-circle-o"></i>Trash<span class="label bg-green pull-right">4</span></a></li>
            <li><a href="./page/task/archive-task.php"><i class="fa fa-circle-o"></i>Archive<span class="label label-warning pull-right">4</span></a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
              <li>
                <a href="./page/calendar/calendar.php"><i class="fa fa-circle-o"></i> Activity 
                  <span class="pull-right-container">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="./page/options/role.php"><i class="fa fa-circle-o"></i>Admin Roles</a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <h4>Today <b>(<script>var today = new Date();
          var dd = String(today.getDate()).padStart(2, '0');
          var mm = String(today.getMonth() + 1).padStart(2, '0'); //January is 0!
          var yyyy = today.getFullYear();
          
          today = mm + '/' + dd + '/' + yyyy;
          document.write(today);</script>)</b></h4>
      <ol class="breadcrumb">
          ...
          <div class="box">
            ...
            <div class="box-body">
              <div class="row">
                <div class="col-md-8">
                  <p class="text-center">
                    <strong> 1 Jan, 2019 - 30 Jul, 2014</strong>
                  </p>
                ...
                <div class="col-md-4">
                  ...
                  <div class="progress-group">
                    <span class="progress-text">Completed Task</span>
                  ...
                  <!-- /.progress-group -->
                  <div class="progress-group">
                    <span class="progress-text">Completed Cases</span>
                  ...
                  <!-- /.progress-group -->
                  <div class="progress-group">
                    <span class="progress-text">Feedback Sent</span>
                  ...
                  <!-- /.progress-group -->
                  <div class="progress-group">
                    <span class="progress-text">Inquiries Sent</span>
              ...
              <div class="row">
                <div class="col-sm-3 col-xs-6">
                  <div class="description-block border-right">
                    ...
                    <span class="description-text">TOTAL FEEDBACK</span>
                  </div>
                  <!-- /.description-block -->
                </div>
                <!-- /.col -->
        ...
        <div class="col-md-6">
          ...
          <div class="info-box bg-yellow">
            ...
            <div class="info-box-content">
              <span class="info-box-text"> Concessions</span>

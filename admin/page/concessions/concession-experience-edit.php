...
include("../../../php_action/edit/concession_experience.php");
      ...
      <div class="row">
          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-7">
                <input type="text" class="form-control" value = "<?php echo $row40[4]?>" name="id" id="xpnumber" placeholder="Experience Number">
              </div>
            </div>
            <div class="form-group">
              <label class="col-sm-3 control-label" for="xpcons">Profile</label>
              <div class="col-sm-7">
                  <select  class="form-control select2" names="name" id="xpcons">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-7">
                <input type="text" class="form-control" value = "<?php echo $row40[1]?>" name="place" id="xpplace" placeholder="Place">
              </div>
            </div>
            <div class="form-group">
              <label class="col-sm-3 control-label" for="xpdatestart">Date Start</label>
              <div class="col-sm-7">
                <input type="date" class="form-control" value = "<?php echo $row40[2]?>" name="date_start" id="xpdatestart" placeholder="Date Started">
              </div>
            </div>
            <div class="form-group">
              <label class="col-sm-3 control-label" for="xpdateend">Date Ended</label>
              <div class="col-sm-7">
                <input type="date" class="form-control" value = "<?php echo $row40[3]?>" name="date_end" id="xpdateend" placeholder="Date Ended">
              </div>
            </div>
          </div>

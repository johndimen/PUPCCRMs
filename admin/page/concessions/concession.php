              ...
              <div class="box box-solid">
                ...
                <div class="box-body no-padding">
                  <ul class="nav nav-pills nav-stacked">
                    <li class="active"><a href="./concession.html"><i class="fa fa-th-large"></i> Concessionbox</a></li>
                    <li><a href="./concession-archive.html"><i class="fa fa-archive"></i> Archive <span class="label label-warning pull-right">65</span></a></li>
                    <li><a href="./concession-trash.html"><i class="fa fa-trash"></i> Trash</a></li>
                  </ul>
                </div>
                <!-- /.box-body -->
              </div>

            ...
            <div class="col-md-3">
              ...
              <div class="col-md-9">
                  <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title"><strong>View Trashed Item/Product</strong></h3>
                        </div>
                        <div class="modal-body form-horizontal ">
                <center><h4>Item/Product Details</h4></center>
                <br>
                        <div class="form-group">
                                <label for="viewItemNumber" class="col-sm-4 control-label">Item Number</label>
                            ...
                            <div class="form-group">
                                <label for="viewProfile" class="col-sm-4 control-label">Profile Name</label>
                            ...
                            <div class="form-group">
                                <label for="viewItemName" class="col-sm-4 control-label">Item Name</label>
                            ...
                            <div class="form-group">
                                <label for="viewItemType" class="col-sm-4 control-label">Item Type</label>
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" id="viewItemName" name="viewItemName" placeholder="Item Type" disabled>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="viewItemPrice" class="col-sm-4 control-label">Item Price</label>
                            ...
                            <div class="form-group">
                                <label for="viewItemDesc" class="col-sm-4 control-label">Item Description</label>

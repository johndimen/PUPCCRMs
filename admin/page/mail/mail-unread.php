  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="../cases/newcases.php"><i class="fa fa-circle-o"></i> New Cases <span class= "label bg-green pull-right">4</span></a></li>
            <li><a href="#"><i class="fa fa-circle-o"></i> Pending Cases <span class="label label-warning pull-right">4</span></a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
      ...
      <li class="treeview active">
        ...
        <ul class="treeview-menu">
          <li class=" active">
            <a href="./mailbox.php"><i class="fa fa-circle-o"></i>Inbox
              <span class="pull-right-container">
                <span class="label label-primary pull-right">13</span>
              </span>
            </a>
          </li>
          <li><a href="./mail-unread.php"><i class="fa fa-circle-o"></i>Unread</a></li>
          ...
          <div class="box box-solid">
            ...
            <div class="box-body no-padding">
              <ul class="nav nav-pills nav-stacked">
                ...
                <li class="active"><a href="./mail-unread.php"><i class="fa fa-envelope"></i> Unread</a></li> 
                <li><a href="./mail-read.php"><i class="fa fa-envelope-open"></i> Read</a></li>
                <li><a href="./trash-mail.php"><i class="fa fa-trash"></i> Trash</a></li>
              </ul>
            </div>
            <!-- /.box-body -->
          </div>
            ...
            <div class="box-body no-padding">
              ...
              <div class="table-responsive mailbox-messages">
                <table class="table table-hover table-striped">
                  ...
                  <?php $action ='<a href="./read-mail.php" class="btn btn-info">View</a>';?>
                  <tr>
...
<!-- Page Script -->
<script src="../../dist/js/pages/mailbox.js"></script>

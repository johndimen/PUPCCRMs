        ...
        <ul class="sidebar-menu" data-widget="tree">
          ...
          <li class="treeview">
              <a href="../reports/report.php">
                ...
                <ul class="treeview-menu">
                  <li class=""><a href="../reports/report-concession.php">Concession Reports</a></li>
                  <li><a href="../reports/report-feedback.php">Feedback Reports</a></li>
                  <li><a href="../reports/report-cases.php">Case Reports</a></li>
                  <li><a href="../reports/report-system-trail.php">System Trail Reports</a></li>
                </ul>
              </li>
          <li class="treeview">
            <a href="#">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
          ...
          <li class="active"><a href="#">Archive Cases</a></li>
        </ol>
      </section>
...
<!-- Page Script -->
<script src="../../dist/js/pages/archive-cases.js"></script>
<script>

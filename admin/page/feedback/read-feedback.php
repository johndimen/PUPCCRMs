      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="./read-feedback.php"><i class="fa fa-circle-o"></i> Read Feedback <span class="label label-default pull-right">4</span></a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
          ...
          <div class="box box-solid">
            ...
            <div class="box-body no-padding">
                <ul class="nav nav-pills nav-stacked">
                    ...
                    <li class="active"><a href="./read-feedback.php"><i class="fa fa-envelope-open"></i> Read</a></li>
                ...
                <table class="table table-hover table-striped">
                  <tbody>
                    ...
                    <?php
                      $action = '
                      <div class="btn-group">
                        <a type="button" class="btn btn-info " href="./read-feedback-view.php">View</a>
                      </div>
                      ';
                    ?>
                    <tr>

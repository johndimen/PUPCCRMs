...
<head>
  ...
  <title>PUPCCRMs | Categories</title>
...
<div class="wrapper">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active"><a href="./categories.php"><i class="fa fa-tags"></i> <span>Categories</span></a></li>
        <li class="treeview">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
          Categories
          <small>All system Categories</small>
        </h1>
        <ol class="breadcrumb">
          ...
          <div class="col-md-12">
              ...
              <div class="box collapsed-box">
                      <div class="box-header with-border">
                        <h3 class="box-title"><strong>Items/Products</strong> </h3>
                    ...
                    <div class="box collapsed-box">
                      ...
                      <!-- Other Items-->
                        <div class="box collapsed-box">
                          <div class="box-header with-border">
                            <h3 class="box-title"><strong>Contract</strong></h3>
                              <div class="box-tools pull-right">
                                <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-plus"></i>
                                </button>
                              </div>
  ...
  <!-- /.content-wrapper -->
    ...
    <div class="modal modal-default fade" id="additemmodal">
        <div class="modal-dialog">
            <div class="modal-content" style="border-radius:10px">
                <div class="modal-header">
                    <h3 class="modal-title">Add Item/Product Category</h3>
                </div>
                <form class="form-horizontal" action="" method="post">
                    <div class="modal-body">
                        <h4>Item Category</h4>
                        <div class="form-group">
                            <label class="col-md-3 control-label" for="number">ID Number</label>
                            <div class="col-md-8">
                        ...
                        <div class="form-group">
                            <label class="col-md-3 control-label" for="price">Price (SRP)</label>
                            <div class="col-md-8">
    ...
    <div class="modal modal-default fade" id="addservicemodal">
        <div class="modal-dialog">
            <div class="modal-content" style="border-radius:10px">
                <div class="modal-header">
                ...
                <form class="form-horizontal" action="" method="post">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <textarea name="servicedescription" id="servicedescription" rows="5" class="form-control" placeholder="Description"></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="modal-footer">
    ...
    <div class="modal modal-default fade" id="addcontractmodal">
        <div class="modal-dialog">
            <div class="modal-content" style="border-radius:10px">
                <div class="modal-header">
                    <h3 class="modal-title">Add Contract Category</h3>
                </div>
                <form class="form-horizontal" action="" method="post">
                    <div class="modal-body">
                        <h4>Contract Category</h4>
                        <div class="form-group">
                            <label class="col-md-3 control-label" for="number">ID Number</label>
                            <div class="col-md-8">
                                <input type="text" name="number" id="number" class="form-control" disabled>
                        ...
                        <div class="form-group">
                            <label class="col-md-3 control-label" for="servicename">Contract Name</label>
                            <div class="col-md-8">
                                <input type="text" name="servicename" id="servicename" class="form-control" placeholder="Contract Name">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-3 control-label" for="description">Description</label>
                            <div class="col-md-8">
                                <textarea name="contractdescription" id="contractdescription" rows="5" class="form-control" placeholder="Description"></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="modal-footer">
    ...
    <div class="modal fade modal-default" id="viewitemModal">
        <div class="modal-dialog">
            <div class="modal-content" style="border-radius:10px">
                <div class="modal-header">
                    <h3 class="modal-title">View Item Category</h3>
                </div>
                <div class="form-horizontal modal-body">
                    <h4>Item Category</h4>
                        ...
                        <div class="form-group">
                            <label class="col-md-3 control-label" for="name">Item Name</label>
                            <div class="col-md-8">
                                <input type="text" name="name" id="name" class="form-control" placeholder="Item Name" disabled>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-3 control-label" for="price">Price (SRP)</label>
                            <div class="col-md-8">
                                <input type="number" min="0" name="price" id="price" class="form-control" placeholder="Price" disabled>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-3 control-label" for="description">Description</label>
                            <div class="col-md-8">
                                <textarea name="description" id="description" rows="5" class="form-control" placeholder="Description" disabled></textarea>
                            </div>
                        </div>
                </div>
                <div class="modal-footer">
    ...
    <div class="modal fade modal-default" id="viewserviceModal">
        <div class="modal-dialog">
            <div class="modal-content" style="border-radius:10px">
                <div class="modal-header">
                    <h3 class="modal-title">View Service Category</h3>
                </div>
                <div class="form-horizontal modal-body">
                    <h4>Service Category</h4>
                        ...
                        <div class="form-group">
                            <label class="col-md-3 control-label" for="servicename">Service Name</label>
                            <div class="col-md-8">
                                <input type="text" name="servicename" id="servicename" class="form-control" placeholder="Service Name" disabled>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-3 control-label" for="servicedescription">Description</label>
                            <div class="col-md-8">
                                <textarea name="servicedescription" id="servicedescription" rows="5" class="form-control" placeholder="Description" disabled></textarea>
                            </div>
                        </div>
                </div>
                <div class="modal-footer">
    ...
    <div class="modal fade modal-default" id="viewcontractModal">
        <div class="modal-dialog">
            <div class="modal-content" style="border-radius:10px">
                <div class="modal-header">
                <h3 class="modal-title">View Contract Category</h3>
                </div>
                <div class="form-horizontal modal-body">
                        <h4>Contract Category</h4>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label class="col-md-3 control-label" for="servicename">Contract Name</label>
                            <div class="col-md-8">
                                <input type="text" name="servicename" id="servicename" class="form-control" placeholder="Contract Name" disabled>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-3 control-label" for="description">Description</label>
                            <div class="col-md-8">
                                <textarea name="contractdescription" id="contractdescription" rows="5" class="form-control" placeholder="Description" disabled></textarea>
                            </div>
                        </div>
                </div>
                <div class="modal-footer">
    ...
    <div class="modal modal-default fade" id="edititemModal">
        <div class="modal-dialog">
            <div class="modal-content" style="border-radius:10px">
                <div class="modal-header">
                <h3 class="modal-title">Edit Item/Product Category</h3>
                </div>
                <form class="form-horizontal" action="" method="post">
                    <div class="modal-body">
                        <h4>Item Category</h4>
    ...
    <div class="modal modal-default fade" id="editserviceModal">
        <div class="modal-dialog">
            <div class="modal-content" style="border-radius:10px">
                <div class="modal-header">
                <h3 class="modal-title">Edit Services Category</h3>
                </div>
                <form class="form-horizontal" action="" method="post">
                    <div class="modal-body">
                        <h4>Item Category</h4>
    ...
    <div class="modal modal-default fade" id="editcontractModal">
        <div class="modal-dialog">
            <div class="modal-content" style="border-radius:10px">
                <div class="modal-header">
                    <h3 class="modal-title">Edit Contract Category</h3>
                </div>
                <form class="form-horizontal" action="" method="post">
                    <div class="modal-body">
                    <h4>Contract Category</h4>

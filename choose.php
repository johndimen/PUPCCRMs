                ...
                <div class="row align-items-center justify-content-between d-flex">
                  ...
                  <nav id="nav-menu-container">
                    <ul class="nav-menu">
                      ...
                      <li class="manu-active"><a href="#choose">Choose</a></li>
...
<!--start here the form ***********************************************************************-->
                    ...
                    <div class="col-md-12 mt-30">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <center><a href="feedback.php" class="genric-btn primary circle arrow ">Complaint</a></center>
                            </div>
                            <div class="col-md-6">
                                <center><a href="survey.php" class="genric-btn primary circle arrow ">Suggestions/Commendation Survey</a></center>
                            </div>
                        </div>

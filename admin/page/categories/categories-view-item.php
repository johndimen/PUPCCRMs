...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
          Categories
          <small>Add System Categories</small>
        </h1>
        <ol class="breadcrumb">
      ...
      <div class="col-md-12">
        <div class="box box-bordered box-primary">
          <div class="box-header">
            <h3 class="box-title">View Items/Products Category</h3>
          </div>
        <form class="form-horizontal" action="" method="post">
          <div class="box-content">
          <center><h4>Item/Products Category</h4></center>
          ...
          <div class="box-footer">
            ...
            <a type="button" name="edit" class="btn btn-info pull-right" href="./categories-edit-item.php">Edit</a>
          </div>
        </form> 
        </div>
      </div>

...
<head>
    ...
    <body>
                ...
                <div class="row align-items-center justify-content-between d-flex">
                  ...
                  <nav id="nav-menu-container">
                    <ul class="nav-menu">
                      ...
                      <li class="manu-active"><a href="#complain">Complain</a></li>
        ...
        <div class="whole-wrap">
            <div class="container">
                <div class="section-top-border" id="complain">
<!--start here the form ***********************************************************************-->
                    ...
                    <h5>Complaints</h5>
                    <p>We aim to acknowledge your complaint in writing within the day and will seek to resolve your complaint, where possible. Complex complaints may take longer to deal with, but we will always keep you updated on our progress.</p>
                    <p>The member of our staff who receives your complaint will see it through to resolution. He or she may liaise with other colleagues along the way, in order to gather the information necessary to respond to you effectively.</p>

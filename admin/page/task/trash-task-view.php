...
<head>
  ...
  <title>PUPCCRMs | Trash Task</title>
        ...
        <ul class="sidebar-menu" data-widget="tree">
          ...
          <li class="treeview active">
            ...
            <ul class="treeview-menu">
              ...
              <li  class="active"><a href="./trash-task.php"><i class="fa fa-circle-o"></i>Trash<span class="label bg-green pull-right">4</span></a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
          ...
          <li class="active"><a href="#">Trash Task</a></li>
        </ol>
      </section>
              ...
              <div class="box box-solid">
                ...
                <div class="box-body no-padding">
                  <ul class="nav nav-pills nav-stacked">
                    ...
                    <li class="active"><a href="./trash-task.php"><i class="fa fa-trash"></i> Trash</a></li>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-6">
                      <br>
                        ...
                        <br>
                  <div class="form-group">
                    <label for="id" class="col-sm-3 control-label">Case Number</label>

                    <div class="col-sm-8">
                      <input type="text" class="form-control pull-right" id="id" name="id" placeholder="Case Number" disabled>
                    </select>
                    </div>
                  </div>
                  <div class="form-group">
...
<!-- Page Script -->
<script src="../../dist/js/pages/pending-task.js"></script>
<script>

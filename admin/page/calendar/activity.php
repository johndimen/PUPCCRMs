          ...
          <div class="col-md-3">
              ...
              <div class="box box-solid">
                ...
                <div class="box-body no-padding">
                  <ul class="nav nav-pills nav-stacked">
                    <li class="active"><a href="./activity.php"><i class="fa fa-th-large"></i> Activitybox
            ...
            <div class="col-md-9">
                <div class="box box-primary">
                  <div class="box-header with-border">
                    <h3 class="box-title"><strong>ActivityBox</strong></h3>
      ...
      <div class="modal-dialog">
        <div class="modal-content" style="border-radius:10px">
          ...
          <form class="form-horizontal" action="" method="post">
            ...
            <div class="modal-footer">
              <button type="button" name="addClose"class="btn btn-default pull-left" data-dismiss="modal">Close</button>

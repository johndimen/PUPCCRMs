...
<div class="wrapper">
    ...
    <section class="content">
      ...
      <div class="row">
          <div class="col-md-3">
              ...
              <button data-toggle="modal" data-target="#addTask" class="btn btn-primary btn-block margin-bottom">Add Task</button>
  ...
  $assigned = $_POST['adminname'];

  $rand = rand(0,999999999);

  $addtasksql = "INSERT INTO `crm_tasklist`(`CRM_Task_SerialNo`, `CRM_Task_Case_SerialNo_FK` , `CRM_Task_Status_Type`, `CRM_Task_Assigned_UserName`, `CRM_Task_Priority_Type`, `CRM_Task_Name`, `CRM_Task_Case_Name`, `CRM_Start_Date`, `CRM_Due_Date`, `CRM_Task_Description`) 
    VALUES ('$rand','$casenumber','$status1','$assigned','$priority1','$taskname','$casename','$datestart','$datedue','$description')";

    $addtaskquery = $conn->query($addtasksql);
    if($addtaskquery == true){

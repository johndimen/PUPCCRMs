      ...
      <div class="col-md-12">
        <div class="box box-bordered box-primary">
          <div class="box-header">
            <h3 class="box-title">View Services Category</h3>
          </div>
        <form class="form-horizontal" action="" method="post">
          <div class="box-content">
          <center><h4>Services Category</h4></center>
          ...
          <div class="box-footer">
                ...
                <a type="button" name="edit" class="btn btn-info pull-right" href="./categories-edit-services.php">Edit</a>
          </div>
        </form> 
        </div>
      </div>

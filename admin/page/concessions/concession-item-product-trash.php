      ...
      <section class="content">
        ...
        <div class="row">
            <div class="col-md-3">
                ...
                <div class="box box-solid">
                  ...
                  <div class="box-body no-padding">
                    <ul class="nav nav-pills nav-stacked">
                      ...
                      <li class="active"><a href="./concession-item-product-trash.php"><i class="fa fa-trash"></i> Trash</a></li>
                    </ul>
                  </div>
                  <!-- /.box-body -->
                </div>
              ...
              <!-- /.col -->
              <div class="col-md-9">
                  <div class="nav-tabs-custom" id="item_tab">
                      <ul class="nav nav-tabs">
                          <li class="active"><a href="#food_item" data-toggle="tab">Food Item</a></li>
                          <li><a href="#nonfood_item" data-toggle="tab">Non-Food Item</a></li>
                          <li><a href="#other_item" data-toggle="tab">Other Item</a></li>
                      </ul>
                      <div class="tab-content">
                          <div class="active tab-pane" id="food_item"> 
                              <div class="box box-solid">
                                      ...
                                      <table class="table table-striped">
                                          <tbody>
                                              ...
                                              <tr>
                                                ...
                                                <td><?php echo $food['CRM_Concession_Item_SerialNo']; ?></td>
                                                <td><?php echo $food['CRM_Concession_Item_Profile_Name']; ?></td>
                                                <td><?php echo $food['CRM_Concession_Item_Name']; ?></td>
                          ...
                          <div class="tab-pane" id="nonfood_item">
                              <div class="box box-solid">
                                  <div class="box-header with-striped">
                                      ...
                                      <table class="table table-striped">
                                          <tbody>
                                              ...
                                              <tr>
                                                ...
                                                <td><?php echo $nonfood['CRM_Concession_Item_Description']; ?></td>
                                                <td><?php echo $nonfood['CRM_Concession_Item_Price']; ?></td>
                                                <td>
                                                  <?php echo $action ?>
                                                </td>
                                              </tr>
                          ...
                          <div class="tab-pane" id="other_item">
                              <div class="box box-solid">
                                  <div class="box-header with-striped">
                                      ...
                                      <table class="table table-striped">
                                          <tbody>
                                              ...
                                              <tr>
                                                ...
                                                <td><?php echo $other['CRM_Concession_Item_Description']; ?></td>
                                                <td><?php echo $other['CRM_Concession_Item_Price']; ?></td>
                                                <td>
                                                  <?php echo $action ?>
                                                </td>
                                              </tr>
          ...
          <div class="modal-dialog">
            <div class="modal-content" style="border-radius:10px">
              <div class="modal-header">
                ...
                <h4 class="modal-title">View Concession Items/Products</h4>
              </div>
                <div class="modal-body form-horizontal ">
                <h4>Item/Product Details</h4>
                <hr>
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <textarea type="text" class="form-control" id="viewItemDesc" name="viewItemDesc" placeholder="Item Description" disabled></textarea>
                                </div>
                            </div>
                </div>

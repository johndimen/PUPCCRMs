          ...
          <div class="col-md-3">
            ...
            <div class="col-md-9">
                <div class="box box-primary">
                  <div class="box-header with-border">
                    <h3 class="box-title"><strong>New Activity</strong></h3>
                    <form class="form-horizontal" action="" method="post">
            <div class="modal-body"> 
              <center><h4>Activity Details</h4></center>
              <br>
            <div class="form-group">
              <label for="addActivityName" class="col-sm-3 control-label">Activity Name</label>
              <div class="col-sm-8">
                <input type="text" class="form-control" id="addActivityName" name="addActivityName" placeholder="Activity Name" >
              </div>
            </div>
              <div class="form-group">
                <label for="addDateStart" class="col-sm-3 control-label">Date Start</label>
                  <div class="col-sm-8 input-group date" style="width: 64.8%;padding-left: 15px;">
                    <div class="input-group-addon">
                      <i class="fa fa-calendar"></i>
                    </div>
                    <input type="date" class="form-control pull-right" id="addDateStart" name="addDateStart">
                  </div>
              </div>
                <div class="form-group">
                  <label for="addDateEnd" class="col-sm-3 control-label">Date End</label>
                    <div class="col-sm-8 input-group date" style="width: 64.8%;padding-left: 15px;">
                      <div class="input-group-addon">
                        <i class="fa fa-calendar"></i>
                      </div>
                      <input type="date" class="form-control pull-right" id="addDateEnd" name="addDateEnd">
                    </div>
                </div>
              
                  <div class="form-group">
                    <label for="addTimeStart" class="col-sm-3 control-label">Time Start:</label>
  
                    <div class="input-group col-sm-8" style="padding-left: 15px; padding-right: 15px">
                      <input type="time" class="form-control notifTimePicker" id="addTimeStart" name="addTimeStart">
                  ...
                  <!-- /.form group -->
                  <div class="form-group">
                    <label for="addTimeEnd" class="col-sm-3 control-label">Time End:</label>
  
                    <div class="input-group col-sm-8" style="padding-left: 15px; padding-right: 15px">
                      <input type="time" class="form-control notifTimePicker" id="addTimeEnd" name="addTimeEnd">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-8">
                  <textarea class="form-control" id="addDescription" name="addDescription" placeholder="Description"></textarea>
                </div>
              </div>
            </div>
      ...
      <div class="modal-dialog">
        <div class="modal-content" style="border-radius:10px">
          ...
          <form class="form-horizontal" action="" method="post">
            <div class="modal-body">
              <div class="form-group">
                <label for="editActivityName" class="col-sm-3 control-label">Activity Name</label>
                <div class="col-sm-8">
                  <input type="text" class="form-control" id="editActivityName" name="editActivityName" placeholder="Activity Name" >
                </div>
              </div>
              <div class="form-group">
                <label for="editDateStart" class="col-sm-3 control-label">Date Start</label>
                <div class="col-sm-8 input-group date" style="width: 72.8%;padding-left: 15px;">
                  <div class="input-group-addon">
                    <i class="fa fa-calendar"></i>
                  </div>
                  <input type="date" class="form-control pull-right" id="editDateStart" name="editDateStart">
                </div>
              </div>
              <div class="form-group">
                <label for="editDateEnd" class="col-sm-3 control-label">Date End</label>
                <div class="col-sm-8 input-group date" style="width: 72.8%;padding-left: 15px;">
                  <div class="input-group-addon">
                    <i class="fa fa-calendar"></i>
                  </div>
                  <input type="date" class="form-control pull-right" id="editDateEnd" name="editDateEnd">
                </div>
              </div>
                                      
              <div class="form-group">
                <label for="editTimeStart" class="col-sm-3 control-label">Time Start:</label>
                          
                <div class="input-group col-sm-8" style="padding-left: 15px; padding-right: 15px">
                  <input type="time" class="form-control notifTimePicker" id="editTimeStart" name="editTimeStart">
              ...
              <!-- /.form group -->
              <div class="form-group">
                <label for="editTimeEnd" class="col-sm-3 control-label">Time End:</label>
                          
                <div class="input-group col-sm-8" style="padding-left: 15px; padding-right: 15px">
                  <input type="time" class="form-control notifTimePicker" id="editTimeEnd" name="editTimeEnd">
            ...
            <div class="modal-footer">
              <button type="button" name="editClose"class="btn btn-default pull-left" data-dismiss="modal">Close</button>
...
<!-- Page Script -->
<script src="../../dist/js/pages/activity.js"></script>
<script>

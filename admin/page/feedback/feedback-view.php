      ...
      <div class="row">
        ...
        <div class="col-md-9">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-8">
              <input type="text" value = "<?php echo $row29[0]?>" class="form-control" id="feedbackno" name="feedbackno" placeholder="Feedback Number" disabled>
            </div>
          </div>
          <div class="form-group">
    ...
    <div class="modal-dialog" style="margin-left: 100px;width: 1150px;">
      <div class="modal-content" style="border-radius:10px">
        ...
        <div class="row">
          ...
          <div class="form-group">
            <label for="stallarea" class="col-sm-4 control-label">Stall Location</label>
            <div class="col-sm-8">
              <input type="text" class="form-control" id="stallarea" name="stallarea" placeholder="Stall Location">
            </div>
          </div>
          <div class="form-group">
            <label for="evaluation" class="col-sm-4 control-label">Evaluation</label>
          ...
          <div class="form-group">
            <label for="sendertype" class="col-sm-4 control-label">Sender Type</label>
            <div class="col-sm-8">
              <input type="text" class="form-control" id="sendertype" name="sendertype" placeholder="Sender Type">
            </div>
          </div>
          <div class="form-group">
            <label for="email" class="col-sm-4 control-label">E-mail</label>

...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
          Categories
          <small>View System Categories</small>
        </h1>
        <ol class="breadcrumb">
    ...
    <section class="content">
      <div class="btn-group">
        <a href="../../index.php" class="btn btn-primary btn-block margin-bottom" style="margin-right:10px;width:250px">Back to Dashboard</a>
        <a href="./categories.php" class="btn btn-primary " style="width:250px">Back to Category List</a>
      </div>
      <div class="col-md-12">
        <div class="box box-bordered box-primary">
          <div class="box-header">
            <h3 class="box-title">View Contract Category</h3>
          </div>
        <form class="form-horizontal" action="" method="post">
          <div class="box-content">
          <center><h4>Contract Category</h4></center>
          ...
          <div class="box-footer">
                <a type="button" name="delete" data-target="#deleteServiceModal" data-toggle="modal" class="btn btn-danger">Delete</a>
                <a type="button" name="edit" class="btn btn-info pull-right" href="./categories-edit-contract.php">Edit</a>
          </div>
        </form> 
        </div>
      </div>

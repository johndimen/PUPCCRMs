...
include("../../../php_action/edit/concession_items.php");
        ...
        <div class="row">
            <div class="col-md-3">
              ...
              <div class="col-md-9">
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title"><strong>Edit Item/Product</strong></h3>
                        </div>
          ...
          <center><h4>Items/Product Details</h4></center>
            ...
            <div class="form-group">
                                ...
                                <div class="col-sm-7">
                                    <input type="text" value = "<?php echo $row[6]?>" class="form-control" id="inputItemNumber" name="id" placeholder="Item Number">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-7">
                                    <select class="form-control select2" style="width: 100%;" name="serial" id="inputProfile">
                                        
                                        <option value="<?php echo $row[4]?>"> <?php echo $row[4]?> - <?php echo $row[5]?></option>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-7">
                                <input type="input" class="form-control" value = "<?php echo $row[0]?>" id="inputItemPrice" name="item">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-7">
                                    <input type="number" min="0" class="form-control" value = "<?php echo $row[2]?>" id="inputItemPrice" name="price" placeholder="Item Price">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-7">
                                    <textarea type="text" value = "<?php echo $row[3]?>" class="form-control" id="inputItemDesc" name="description" rows="5" placeholder="Item Description"></textarea>
                                </div>
                            </div>
                            <?php }?>

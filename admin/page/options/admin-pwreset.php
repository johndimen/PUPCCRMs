    ...
    <!-- Default box -->
      <div class="box">
        <div class="box-header with-border">
            <h3 class="box-title"><strong>Admin Password Reset</strong> </h3>
        ...
        <form class="form-horizontal" action="" method="post">
          <div class="box-body">
            ...
            <div class="form-group">
              <label for="conpassword" class="col-sm-5 control-label">New Password</label>
              <div class="col-sm-4">
                <input id="conpassword" name ="conpassword" type="password" class="form-control" placeholder="Confirm New Password">
              </div>
            </div>  
          </div>
          <div class="box-footer">
            <button type="reset" name="reset"class="btn btn-default pull-left">Reset Fields</button>
            <button type="submit" name="submit" class="btn btn-success pull-right">Change</button>
          </div>
        </form>
      </div>
      <!-- /.box -->

...
<head>
  ...
  <title>PUPCCRMs | Admin Login Detail</title>
...
<div class="wrapper">
      ...
      <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
          ...
          <li class="treeview active">
                ...
                <ul class="treeview-menu">
                  <li class="treeview active"><a href="#"><i class="fa fa-circle-o"></i> Admins <span class="pull-right-container"><i class="fa fa-angle-left pull-right"></i></span></a>
                    <ul class="treeview-menu">
                        <li><a href="./admin-profile.php"><i class="fa fa-circle-o"></i> Admin Detail </a></li>
                        <li class="active"><a href="./admin-login-detail.php"><i class="fa fa-circle-o"></i> Admin Login </a></li>
                    </ul>
                  </li>
                  <li class="treeview "><a href="./permission.php"><i class="fa fa-circle-o"></i> Permissions <span class="pull-right-container"><i class="fa fa-angle-left pull-right"></i></span></a>
                    <ul class="treeview-menu">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
            <h1>
              Admin Login
              <small>Admin Login Detail</small>
            </h1>
            <ol class="breadcrumb">
    ...
    <section class="content">
        <div class="row">
        <a href="../../index.php" class=" btn btn-primary margin-bottom" style="margin-left:20px">Back to Dashboard</a>
        <a href="./admin-login-detail.php" class="btn btn-primary margin-bottom">Back to Admin Login Details</a>
        
        </div>  
    <!-- Default box -->
      <div class="box">
        <div class="box-header with-border">
            <h3 class="box-title"><strong>Admin Detail</strong> </h3>
        ...
        <div class="row">
            ...
            <div class="form-group">
              ...
              <div class="row">
                <div class="col-sm-2" style="width: 10%; padding-right: 5px">
                  <input id="salutation" name ="salutation" type="text" class="form-control" placeholder="Mr./Ms./Mrs." disabled>
                </div>
                <div class="col-sm-3" style="width: 170px;padding-left: 5px; padding-right: 5px">
                  <input type="text" id="firstName" name="firstName" class="form-control" placeholder="First Name" disabled>
                </div>
                <div class="col-sm-2" style="width:100px;padding-left: 5px; padding-right: 5px">
                  <input type="text" id="middleName" name="middleName" class="form-control" placeholder="Middle Name" disabled>
                </div>
                <div class="col-md-3" style="width: 170px;padding-right:5px;padding-left: 5px">
                  <input type="text" id="lastName" name="lastName" class="form-control" placeholder="Last Name" disabled>
                </div>
                <div class="col-md-2" style="width: 85.5px;padding-left: 5px">
                  <input type="text" id="extName" name="extName" class="form-control" placeholder="jr"  disabled>
                </div>
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <input type="text" id="jobTitle" name="jobTitle" class="form-control" placeholder="Job Title"  disabled>
              </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <input type="email" id="email" name="email" class="form-control" placeholder="E-mail"  disabled>
              </div>
            </div>
            <div class="form-group">
              <label for="highestEducation" class="col-sm-2 control-label">Highest Education</label>
              <div class="col-sm-10">
                <input type="text" id="highestEducation" name="highestEducation" class="form-control" placeholder="Highest Education" disabled>
              </div>
            </div>
            <div class="form-group">
              <label for="location" class="col-sm-2 control-label">Address</label>
              <div class="col-sm-10">
                <textarea id="location" name="location" class="form-control" rows="4" placeholder="Address" disabled></textarea>
            ...
            <div class="col-md-4">
                <br>
            <center><h4>Login Details</h4></center>
            <div class="form-group">
            ...
            <br>
            <center><h4>Role Details</h4></center>
            <div class="form-group">
              <label for="roleType" class="col-sm-4 control-label">Admin Role</label>
              <div class="col-sm-7">
                  <input type="text" name="jobtitle" id="jobtitle" class=" form-control" placeholder="Admin Role" disabled>
              </div>
            </div> 
            <div class="form-group">
              <label for="roledesc" class="col-sm-4 control-label">Role Description</label>
              <div class="col-sm-7">
                  <textarea class="form-control" name="roledesc" id="roledesc"rows="5" disabled></textarea>
              </div>
            </div>
          </div>
        </div>
          <div class="box-footer">
            <button type="button" name="delete" id="delete" class="btn btn-danger pull-left">Delete</button>
              <a href="./admin-edit.php" class="btn btn-info pull-right">Edit</a>
          </div>
      </div>
      <!-- /.box -->
...
<!-- Page Script -->
<script src="../../dist/js/pages/admin-login-detail.js"></script>
<script>
